...
public ListNode reverseList(ListNode head) {
    ...
    while (head != null && head.next != null) {
        ...
        head.next = move.next; // 删除第二个

        move.next = sentinel.next;
        sentinel.next = move;
    }
    return sentinel.next;
}
...
![image-20240105191842921](https://erick-typora-image.oss-cn-shanghai.aliyuncs.com/img/image-20240105191842921.png)
